    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <div className="w-full max-w-sm space-y-6 text-center">
          <img src="/favicon.svg" alt="ctxnote" className="mx-auto h-14 w-14 rounded-xl border-2 border-border shadow-[4px_4px_0px_hsl(0,0%,15%)] object-cover" />
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link to="/login" className="text-sm font-bold text-muted-foreground hover:underline border-t border-border pt-4">Back to sign in</Link>
          </div>
        </div>
      </div>
    );
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="flex flex-col items-center gap-3">
          <img src="/favicon.svg" alt="ctxnote" className="h-14 w-14 rounded-xl border-2 border-border shadow-[4px_4px_0px_hsl(0,0%,15%)] object-cover" />
        ...
        <div className="space-y-4">
          <button
            ...
            className="brutal-btn flex w-full items-center justify-center gap-3 rounded-lg border-2 border-border bg-card px-4 py-3 text-sm font-bold uppercase tracking-wider text-foreground transition-all hover:bg-accent disabled:opacity-50"
          >
            {googleLoading ? (
