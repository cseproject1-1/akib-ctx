...
export function VaultPasswordDialog({ isOpen, onClose, onVerify, title = 'Vault Locked', message = 'Please enter the vault password to access your locked workspaces', hasPassword = true }: VaultPasswordDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Failed to verify vault password');
