...
export function CanvasStats() {
  ...
  return (
    <div className="fixed left-6 bottom-6 z-40 w-52 max-h-[300px] overflow-y-auto rounded-xl border border-border bg-card shadow-[var(--clay-shadow-md)] animate-brutal-pop scrollbar-none">
