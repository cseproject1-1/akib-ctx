...
import { Trash2, Type, Zap, ZapOff } from 'lucide-react';
...
export function EdgeContextMenu() {
  ...
  const closeMenu = useCallback(() => setEdgeContextMenu(null), [setEdgeContextMenu]);

  // Derive data only if we have a context menu open
      ...
      {edgeContextMenu && (
        <>
          ...
          >
            ...
            <CtxBtn role="menuitem" onClick={handleSetLabel}>
