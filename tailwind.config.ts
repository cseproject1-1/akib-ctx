  ...
  theme: {
    ...
    extend: {
      ...
      zIndex: {
        ...
        nav: "var(--z-nav)",
        drawing: "var(--z-drawing)",
        "drawing-interactive": "var(--z-drawing-interactive)",
        "mobile-modal": "var(--z-mobile-modal)",
        toolbar: "var(--z-toolbar)",
        search: "var(--z-search)",
        presentation: "var(--z-presentation)",
        "context-backdrop": "var(--z-context-backdrop)",
        "context-menu": "var(--z-context-menu)",
        "magic-cursors": "var(--z-magic-cursors)",
        modal: "var(--z-modal)",
        toast: "var(--z-toast)",
        "expand-backdrop": "var(--z-expand-backdrop)",
        "expand-modal": "var(--z-expand-modal)",
        pwa: "var(--z-pwa)",
        synthesis: "var(--z-synthesis)",
        peek: "var(--z-peek)",
        dropdown: "var(--z-dropdown)",
        tutorial: "var(--z-tutorial)",
        history: "var(--z-history)",
        "search-panel": "var(--z-search-panel)",
      },
      animation: {
